...
const iconPaths = {
  ...
  share:
    '<circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><path d="m8.6 10.6 6.8-4.2"/><path d="m8.6 13.4 6.8 4.2"/>',
  shuffle:
...
export default function Icon({ name, size = 22, color = 'currentColor', strokeWidth = 2.2 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
